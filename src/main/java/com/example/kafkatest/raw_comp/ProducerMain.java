...
public class ProducerMain {
    ...
    private static Producer<String, String> createProducer() {
        ...
        properties.put("key.serializer", StringSerializer.class.getName());  // 生产的 key 的序列化方式
        properties.put("value.serializer", StringSerializer.class.getName());  // 生产的 value 的序列化方式

        // 创建 KafkaProducer 对象
        // 因为我们消息的 key 和 value 都是用 String 类型，所以创建的 Producer 是 <String, String> 的泛型
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        ProducerRecord<String, String> message = new ProducerRecord<>("TestTopic", "key", "test1");
